...
//       // 🔥 Reinitialize waiter request JS when waiterRequest page is loaded
...
//   // Loads the correct section after redirect
//   // ============================================
//   (function () {
...
//   // Global waiter request monitoring
//   let globalWaiterMonitor = {
...
//           `/waiterRequest/${branchId}/getNewWaiterRequest`
//         );
...
//         if (this.previousRequestIds.size === 0) {
...
//           console.log("🔔 New waiter requests detected:", newRequests.length);
...
//       console.log(
//         "✅ Global waiter request monitoring started (polling every 10s)"
//       );
//     },
...
//   // Initialize global monitoring when dashboard loads
//   document.addEventListener("DOMContentLoaded", () => {
