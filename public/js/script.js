...
// Example usage: Simulate real-time data update
// Uncomment to test
/*
        setInterval(() => {
            const mockData = {
                todayEarnings: Math.floor(Math.random() * 500),
                todayCustomers: Math.floor(Math.random() * 50),
                avgDailyEarnings: (Math.random() * 100).toFixed(2),
                salesThisMonth: Math.floor(Math.random() * 2000),
                cashPayments: Math.floor(Math.random() * 200),
                cardPayments: Math.floor(Math.random() * 150),
                upiPayments: Math.floor(Math.random() * 180)
            };
